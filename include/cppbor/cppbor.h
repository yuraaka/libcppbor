...
class Item {
  public:
     ...
     * the value returned by hasSemanticTag().
     *
     ...
     * etc.  So in this example, hasSemanticTag() would return 3, and semanticTag(0) would return 5
     * semanticTag(1) would return 5 and semanticTag(2) would return 4.  For values of n > 2,
...
class Map : public Item {
  public:
    ...
    Map() = default;
    Map(size_t reserved_size) : mEntries(reserved_size) {}
